...
const Profile = () => {
  ...
  return (
    <Grid container spacing={2} style={gridStyle}>
      <Grid item xs={11} sm={7} sx={{border:'1px solid #C4C4C4',borderRadius:'5px',paddingRight:'20px', 
      mt:{
          xs:5,sm:'auto',md:'auto',lg:'auto',xl:'auto'
        },
        }}>
        ...
        // mt:{
        //   xs:8,sm:8,md:8,lg:'auto',xl:'auto'
        // },
      ...
      <Grid item xs={11} sm={4} sx={{border:'1px solid #C4C4C4',borderRadius:'5px'}}>
